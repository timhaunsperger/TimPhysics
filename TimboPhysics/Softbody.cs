...
public class Softbody : PhysicsObject
{
        ...
        double timeStep)
    {
        ...
        foreach (var vertexKey in Vertices.Keys)
        {
            centerPos += Vertices[vertexKey].Position/Vertices.Count;
        }
    ...
    public override void Update(List<Softbody> collisionObjects, double deltaTime)
    {
